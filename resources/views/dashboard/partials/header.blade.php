...
<div id="smabig" style="width: 170px;"  class="geex-content__header__action__wrap ceo">
    <ul class="geex-content__header__quickaction">
        <li class="geex-content__header__quickaction__item">
            ...
            <div class="row">
                <div class="col-md-5">
                    <img class="user-img rounded-circle" src="{{ asset('upload/profile/'.auth()->user()->image) }}" alt="image" height="50px">
                </div>
                ...
                @else
                <div>
                    <img class="user-img rounded-circle" src="{{ asset('images/user1.png') }}" alt="image" height="50px">
                    <span>{{ auth()->user()->name }}</span> <i class="uil uil-arrow-down"></i>
                </div>
                @endif
            </a>
            <a id="shown" style="background:color:white" href="#" class="geex-content__header__quickaction__link">
                @if(!empty(auth()->user()->image))
                <div>
                    <img style="border-radius:20px" class="user-img rounded-circle" src="{{ asset('upload/profile/'.auth()->user()->image) }}" alt="image" height="50px">
                </div>
                @else
                <div>
                    <img class="user-img rounded-circle" src="{{ asset('images/user1.png') }}" alt="image" height="50px">
...
<div id="smabig1"  class="geex-content__header__action__wrap ceo">
    <ul class="geex-content__header__quickaction">
        <li class="geex-content__header__quickaction__item">
            <a id="hides" style="background:color:white" href="#" class="geex-content__header__quickaction__link">
                @if(!empty(auth()->user()->image))
