                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input value="{{ $event->number_of_place }}" type="number" name="number_of_place"
                            placeholder="Enter Nombre de place" disabled>
                            <br><br>
                    ...
                    <div class="col-md-4">
                       ...
                       <select style="border: rgb(153, 153, 153) 1px groove;width: 100%;padding: 10px;border-radius: 10px" name="status" class="form-control" disabled>
